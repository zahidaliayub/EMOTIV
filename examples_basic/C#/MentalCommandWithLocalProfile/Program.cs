...
namespace MentalCommandWithCloudProfile
{
    class Program
    {
        ...
        static int userID = -1;
        static string profileNameForLoading = "D:/yourProfileName.emu";
        static string profileNameForSaving = "D:/yourProfileName.emu";
        ...
        {
            Console.WriteLine("MentalCommand Training Success. (A)ccept/(R)Reject?");
        ...
        static void SavingLoadingFunction(int mode)
        {
            ...
            {             
                //Save Profile
                int result = EdkDll.IEE_SaveUserProfile((uint)userID, profileNameForSaving);
                ...
                {
                    Console.WriteLine("Saving unsuccessfully");
                }         
                return;
            }
            if (mode == 1) 
            {
                //Load Profile
                int result = EdkDll.IEE_LoadUserProfile((uint)userID, profileNameForLoading);
                if (result == EdkDll.EDK_OK)
                {
                ...
                {
                    Console.WriteLine("Loading unsuccessfully");
                }
                return;
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("F8: save local profile");
            Console.WriteLine("F9: Load local profile");
